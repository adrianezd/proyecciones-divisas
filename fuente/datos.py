"""
Descarga de cotizaciones: el euro frente al dolar, la libra y el yen.
...
ACTIVOS = [
    ("eurusd", "EURUSD=X", "eurusd", "Euro / dólar", "USD", "Divisas"),
    ("eurgbp", "EURGBP=X", "eurgbp", "Euro / libra", "GBP", "Divisas"),
    ("eurjpy", "EURJPY=X", "eurjpy", "Euro / yen",   "JPY", "Divisas"),
]
