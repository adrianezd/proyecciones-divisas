...
BASE_URL = "https://adrianezd.github.io/proyecciones-divisas"
...
def main() -> None:
    ...
    if not activos:
        print("  SALTADA     divisas (ningun proveedor de cotizaciones respondio)")
    ...
    escribir(
        "activos.html",
        acento="divisas",
        titulo="Euro, dolar, libra y yen: cotizacion y grafica interactiva",
        descripcion="Historico de cierre diario del euro frente al dolar, la libra y el "
                    "yen, con graficas interactivas.",
        encabezado="Divisas",
        bajada="El euro frente al dolar, la libra y el yen. Cierre diario, historico completo.",
